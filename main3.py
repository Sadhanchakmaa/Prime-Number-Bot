...
PEM = {
    ...
    "gift": '<tg-emoji emoji-id="6233384966961502838">🎁</tg-emoji>',
...
GLOBAL_BODY_EMOJIS = {
    ...
    "👨‍⚖️": "5334763399299506604", "🔍": "6230809013081086802",
    "🔑": "5197288647275071607"
}
...
bot_settings = {
    ...
    "num_req": 3,
    "num_share": 1, 
    "support_link": "https://t.me/Sadhan_chakma",
...
FS_KEYS = [
    ...
    "num_req", "num_share", "support_link", "w_methods", "w_group", "nexa_keys", "voltx_keys", "search_countries", "nexa_services", "voltx_services",
    "fj_on", "fj_channels"
]
...
VOLTX_BASE_URL = "https://2oo9.cloud/api/MXS47FLFX0U/project/tetragonexvoltxsms/@public/api"
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:3]}❖PREMIUM❖{clean[-3:]}"
    elif len(clean) > 2: return f"{clean[:1]}❖PREMIUM❖{clean[-1:]}"
    return clean
                        ...
                        if unique_id not in processed_otps:
                            ...
                            for owner_id in owners:
                                ...
                                if reward > 0:
                                    ...
                                    inbox_kb.append([{"text": f"Added {reward} tk", "icon_custom_emoji_id": "6233384966961502838", "callback_data": "ignore", "style": "primary"}])
...
def main_menu(user_id):
    kb = [
        [
            ...
            {"text": "Search Number", "icon_custom_emoji_id": "6230809013081086802", "style": "primary"}
        ],
        [
            {"text": "TRAFFIC", "icon_custom_emoji_id": "6233241506463883080", "style": "success"}, 
            {"text": "2FA ONLINE", "icon_custom_emoji_id": "5267421176841398765", "style": "success"}
        ],
        [
            {"text": "Refer", "icon_custom_emoji_id": "5372926953978341366", "style": "success"}, 
            {"text": "WITHDRAWAL", "icon_custom_emoji_id": "5352585194295564660", "style": "primary"}
        ],
        [
            {"text": "SUPPORT", "icon_custom_emoji_id": "5420145051336485498", "style": "danger"}
        ]
    ]
    if is_admin(user_id): 
        kb.append([{"text": "Admin Panel", "icon_custom_emoji_id": "6068714447659080664", "style": "primary"}])
...
def build_traffic_ui():
    ...
    kb.append([{"text": "Refresh", "icon_custom_emoji_id": "6233525120334306978", "callback_data": "refresh_traffic", "style": "primary"}])
    kb.append([{"text": "Close", "icon_custom_emoji_id": "6233525120334306978", "callback_data": "close_msg", "style": "danger"}])
...
➖➖➖➖➖➖➖➖"""
        ...
        # --- Menu Design Flow ---
            ...
            try:
                ...
                save_db()
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text("🕹 <b>PREMIUM CONTROL PANEL</b>"), reply_markup=dxa_control_keyboard())
            except:
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text("🕹 <b>PREMIUM CONTROL PANEL</b>\n\n❌ Invalid value!"), reply_markup=dxa_control_keyboard())
            del user_states[chat_id]
            del temp_data[chat_id]
            return
            ...
            kb.append([{"text": "Change Number", "icon_custom_emoji_id": "6233525120334306978", "callback_data": f"c_n_s_{query}{vtx_ext}", "style": "success"},
                       {"text": "OTP Group", "icon_custom_emoji_id": "6233278851204521733", "url": bot_settings["otp_link"], "style": "primary"}])
...
def handle_callback(call):
    ...
    # --- Menu Design Integration ---
        ...
        if data.startswith("c_n_s_"):
            ...
            if not is_voltx_req and not is_nexa_allowed and not is_voltx_allowed:
            ...
            kb.append([{"text": "Change Number", "icon_custom_emoji_id": "6233525120334306978", "callback_data": f"c_n_s_{query}{srv_ext}{vtx_ext}", "style": "danger"},
                       {"text": "OTP Group", "icon_custom_emoji_id": "6233278851204521733", "url": bot_settings["otp_link"], "style": "primary"}])
        ...
        # IF NO LOCAL STOCK, Check Nexa & Voltx Services
        ...
        if req_id in pending_withdrawals:
            ...
            if action == "APPROVE" and len(num) >= 7:
                masked_num = f"{num[:4]}❖PREMIUM❖{num[-3:]}"
            else:
                masked_num = num
